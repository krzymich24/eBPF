...
import (
        ...
        "os" //basic os interaction

        "os/signal" //handling signals

        bpf "github.com/iovisor/gobpf/bcc" //github repo with binding bpf
...
//C code defines bpf logic and data structures used by XDP program
...
func usage() { //more usage informtion
